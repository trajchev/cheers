 ...
 */
add_filter( 'dynamic_sidebar_params', 'Cheers_widget_classes' );

if ( ! function_exists( 'Cheers_widget_classes' ) ) {
	/**
	 ...
	 * @return array $params
	 */
	function Cheers_widget_classes( $params ) {
...
} // endif function_exists( 'Cheers_widget_classes' ).

add_action( 'widgets_init', 'Cheers_widgets_init' );

if ( ! function_exists( 'Cheers_widgets_init' ) ) {
	/**
	 * Initializes themes widgets.
	 */
	function Cheers_widgets_init() {
		register_sidebar(
			array(
				'name'          => __( 'Right Sidebar', 'Cheers' ),
				'id'            => 'right-sidebar',
				'description'   => __( 'Right sidebar widget area', 'Cheers' ),
