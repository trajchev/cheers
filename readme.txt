...
Start talking: [![Gitter](https://img.shields.io/gitter/room/holger1411/Cheers.svg?maxAge=2592000?style=flat-square)](https://gitter.im/holger1411/Cheers)
...
You can use it as starter theme and build your own theme on top of it. Or you use it as parent theme and create your own child theme for Cheers.

At the moment, Cheers is in a very early stage. But if you want, feel free to use it for your own WordPress theme!

# Cheers WordPress Theme Framework

Website: [http://Cheers.com](http://Cheers.com)

Child Theme Project: [https://github.com/holger1411/Cheers-child](https://github.com/holger1411/Cheers-child)

## License
Cheers WordPress Theme, Copyright 2013-2017 Holger Koenemann
...
- The `/css/theme.css` and it´s minified little brother `/css/theme.min.css` file(s) provides all styles. It is composed of five different SCSS sets and one variable file at `/sass/theme.scss`:
                  ...
                  - 1 "theme/theme_variables";  // <--------- Add your variables into this file. Also add variables to overwrite Bootstrap or Cheers variables here
                  - 2 "../src/bootstrap-sass/assets/stylesheets/bootstrap";  // <--------- All the Bootstrap stuff - Don´t edit this!
                  - 3 "Cheers/Cheers"; // <--------- Some basic WordPress stylings and needed styles to combine Boostrap and Underscores
...
- Download the Cheers folder from GitHub or from Cheers.com
