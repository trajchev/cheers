	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'Cheers' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'Cheers' ); ?></th>
			</tr>
		</thead>
		<tbody>
